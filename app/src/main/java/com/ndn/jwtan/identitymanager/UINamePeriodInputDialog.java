...
public class UINamePeriodInputDialog extends Fragment {
    ...
    public UINamePeriodInputDialog() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.fragment_ui_add_name_period_input_dialog, container, false);
        ...
        if (!ndnCertModel.nameEditable) {
            layout.findViewById(R.id.name).setVisibility(View.GONE);
        } else {
